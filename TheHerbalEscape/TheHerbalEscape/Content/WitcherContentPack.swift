    ...
    init() {
        ...
        let balissePage1Elements : [BrowserPageElement] =
            [
                ...
                BrowserPageElement.text(BrowserPageText(text: "Balisse fruit is an edible berry characterized by subtle magic resonance. The fruit is apparently poisonous unless soaked in alcohol first, after which it can be used for medicines.", links: [], highlights: [])),
        ...
        let arenariaPage1Elements : [BrowserPageElement] =
            [
                ...
                BrowserPageElement.text(
                    BrowserPageText(
                        text: "Arenaria is a relatively rare plant outside of White Orchard but can also be found in Skellige. You can use it to prepare potions, oils, bombs and decoctions.", links: [],
                            highlights:
                                [
                                    BrowserPageTextHighlight(range: NSRange(location: 0, length: 8), highlightType: .bold),
                                    BrowserPageTextHighlight(range: NSRange(location: 47, length: 13), highlightType: .italics),
                                    BrowserPageTextHighlight(range: NSRange(location: 86, length: 8), highlightType: .italics)
                                ])),
                BrowserPageElement.image(BrowserPageImage(imageName: "arenaria", imageDescription: "A picture of the Arenaria flower")),
                BrowserPageElement.text(BrowserPageText(text: "Here is a link to Celandine.", links: [BrowserPageTextLink(range: NSRange(location: 18, length: 9), target: "Celandine")], highlights: [])),
                ]
        let arenariaPages =
            [
        ...
        let buckthornPage1Elements : [BrowserPageElement] =
            [
                ...
                BrowserPageElement.text(BrowserPageText(text: "Buckthorn is an alchemy ingredient that is found in water, usually on ocean floors and lakebeds. It is used as a lure for Griffins, due to its rotting flesh smell.", links: [], highlights: [])),
